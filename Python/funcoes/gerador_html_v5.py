...
bloco_atrs = ('bloco_accesskey', 'bloco_id') #definindo quais os atributos suportados
ul_atrs = ('ul_id', 'ul_style')


def filtrar_atrs(informados, suportados): #funcao que vai filtrar os atributos
    return ' '.join(f'{k.split("_")[-1]}="{v}"' #split no underline, pegando o ultimo valor
